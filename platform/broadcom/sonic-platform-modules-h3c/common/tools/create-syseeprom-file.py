...
def usage():
    ...
    Usage:
        ...
        Vendor : Tencent
        Product_name : TCS81/TCS83/TCS84
...
def main():
    ...
    arg_err = False
    #if product_name not in ['TCS81', 'TCS83', 'TCS82', 'TCS84']:
    #    print "product name %s is invalid, TCS81/TCS83/TCS82/TCS84" %product_name
    #    arg_err = True
    #if Vendor not in ['H3C', 'Tencent', 'Baidu']:
    #    print "Vendor %s is invalid, H3C/Tencent/Baidu" %Vendor
    #    arg_err = True
    ...
    tlvinfo_data.add_tlv_str(TLV_CODE_SERVICE_TAG, "www.%s.com"%Vendor.lower())
