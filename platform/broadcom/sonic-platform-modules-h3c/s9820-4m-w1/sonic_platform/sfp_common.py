...
# sfp_common.py
#
# Common base class for implementing a platform-specific class with which
...
XCVR_SFP_VENDOR_NAME_OFFSET = 20
XCVR_QSFP_VENDOR_NAME_OFFSET = 20
XCVR_QSFPDD_VENDOR_NAME_OFFSET = 1
XCVR_VENDOR_NAME_WIDTH = 16
XCVR_SFP_VENDOR_OUI_OFFSET = 37
XCVR_QSFP_VENDOR_OUI_OFFSET = 37
XCVR_QSFPDD_VENDOR_OUI_OFFSET = 17
XCVR_VENDOR_OUI_WIDTH = 3
XCVR_SFP_VENDOR_PN_OFFSET = 40
XCVR_QSFP_VENDOR_PN_OFFSET = 40
XCVR_QSFPDD_VENDOR_PN_OFFSET = 20
XCVR_VENDOR_PN_WIDTH = 16
XCVR_SFP_HW_REV_OFFSET = 56
XCVR_QSFP_HW_REV_OFFSET = 56
XCVR_QSFPDD_HW_REV_OFFSET = 36
XCVR_HW_REV_WIDTH_QSFPDD = 2
XCVR_HW_REV_WIDTH_QSFP = 2
XCVR_HW_REV_WIDTH_SFP = 4
XCVR_WAVELENGTH_SFP_OFFSET = 60
XCVR_WAVELENGTH_QSFP_OFFSET = 186
XCVR_WAVELENGTH_QSFPDD_OFFSET = 138
XCVR_WAVELENGTH_QSFPDD_PAGE = 1
XCVR_WAVELENGTH_WIDTH = 2
XCVR_SFP_VENDOR_SN_OFFSET = 68
XCVR_QSFP_VENDOR_SN_OFFSET = 68
XCVR_QSFPDD_VENDOR_SN_OFFSET = 38
XCVR_VENDOR_SN_WIDTH = 16
XCVR_SFP_VENDOR_DATE_OFFSET = 84
XCVR_QSFP_VENDOR_DATE_OFFSET = 84
XCVR_QSFPDD_VENDOR_DATE_OFFSET = 54
XCVR_VENDOR_DATE_WIDTH = 8
XCVR_DOM_CAPABILITY_OFFSET = 92
XCVR_DOM_CAPABILITY_WIDTH = 2
XCVR_QSFPDD_INTERFACE_CONNECTOR_OFFSET = 75
XCVR_QSFPDD_INTERFACE_CONNECTOR_WIDTH = 2
...
QSFPDD_VERSION_COMPLIANCE_OFFSET = 2
QSFPDD_VERSION_COMPLIANCE_WIDTH = 1
QSFPDD_CHANNEL_TX_DISABLE_OFFSET = 130
QSFPDD_CHANNEL_TX_DISABLE_WIDTH = 1
QSFPDD_CHANNEL_TX_DISABLE_PAGE = 0x10
QSFPDD_MODULE_THRESHOLD_OFFSET = 128
QSFPDD_MODULE_THRESHOLD_WIDTH = 72
QSFPDD_MODULE_THRESHOLD_PAGE = 2
QSFPDD_OPTION_VALUE_OFFSET = 155
QSFPDD_OPTION_VALUE_WIDTH = 6
QSFPDD_OPTION_VALUE_PAGE = 1
QSFPDD_POWER_MODE_OFFSET = 3
QSFPDD_POWER_MODE_WIDTH = 1
QSFPDD_TEMP_VALT_OFFSET = 14
QSFPDD_TEMP_VALT_WIDTH = 4
QSFPDD_DOM_OFFSET = 154
QSFPDD_DOM_WIDTH = 48
QSFPDD_DOM_PAGE = 0x11
...
QSFPDD_SET_LPMODE_OFFSET = 26
QSFPDD_SET_LPMODE_WIDTH = 1
# A0
SFP_DOM_OFFSET = 96
SFP_DOM_WIDTH = 10
SFP_TEMPE_OFFSET = 96
...
class SfpCommon(SfpBase):
    ...
    def read_eeprom(self, offset, num, A=None, page=None):
        ...
        self.logger.log_debug('{} read {}, offset={} num={}'.format(self.get_name(), eeprom_path, offset, num))
        ...
        try:
            ...
            if readlen == 0:
                return None
            readlen = min(readlen, num)
            for n in range(0, readlen):
                if sys.version[0] < '3':
    ...
    def write_eeprom(self, offset, value_list, A=None, page=None):
        ...
        self.logger.log_debug('{} read {}, offset={} value={}'.format(self.get_name(), eeprom_path, offset, value_list))
    ...
    def is_qsfpdd(self):
        ...
        """
        if self._is_qsfpdd is None:
            if self.cage_type() == 'SFP':
                self._is_qsfpdd = False
            elif self.cage_type() == 'QSFP':
                byte0 = self.read_eeprom(0, 1)
                if byte0 is not None:
                    self._is_qsfpdd = (byte0 == ['18'])
            else:
                self.logger.log_error('Not implemented {} cage type.'.format(self.cage_type()))
                return None
        return self._is_qsfpdd
    ...
    def is_qsfp(self):
        ...
        if self._is_qsfp is None:
            if self.cage_type() == 'SFP':
                ...
                byte0 = self.read_eeprom(0, 1)
                if byte0 is not None:
                    self._is_qsfp = (byte0 != ['03'] and byte0 != ['0b'] and byte0 != ['18'])
                else:
                    self._is_qsfp = True
            else:
                self.logger.log_error('Not implemented {} cage type.'.format(self.cage_type()))
    ...
    def _xcvr_capability_detect(self):
        ...
        if self.is_qsfp():
            ...
            if self._dom_supported:
                qsfpdd_option_value_raw = self.read_eeprom(
                    QSFPDD_OPTION_VALUE_OFFSET,
                    QSFPDD_OPTION_VALUE_WIDTH,
                    page=QSFPDD_OPTION_VALUE_PAGE)
                qsfp_version_compliance_raw = self.read_eeprom(
                    QSFPDD_VERSION_COMPLIANCE_OFFSET, QSFPDD_VERSION_COMPLIANCE_WIDTH)
                if qsfp_version_compliance_raw is not None:
                    dom_status_indicator = sfpi_obj.parse_dom_capability(qsfp_version_compliance_raw, 0)
                    self._qsfp_page3_available = dom_status_indicator['data']['Flat_MEM']['value'] == 'Off'
                else:
                    self._qsfp_page3_available = False

                if qsfpdd_option_value_raw is not None:
                    self._dom_temp_supported = bool(bin(int(qsfpdd_option_value_raw[4], 16))[-1])
                    self._dom_volt_supported = bool(bin(int(qsfpdd_option_value_raw[4], 16))[-2])
                    self._dom_rx_power_supported = bool(bin(int(qsfpdd_option_value_raw[5], 16))[-3])
                    self._dom_tx_power_supported = bool(bin(int(qsfpdd_option_value_raw[5], 16))[-2])
                    self._dom_tx_disable_supported = bool(bin(int(qsfpdd_option_value_raw[0], 16))[-2])
                else:
                    self._dom_temp_supported = False
                    self._dom_volt_supported = False
                    self._dom_rx_power_supported = False
    ...
    def get_transceiver_info(self):
        ...
        cable_length[n]            |INT            |supported cable length, n =max_len(qsfp/sfp_cable_length_tup)
        ...
        if self.is_qsfp():
            ...
            xcvr_vendor_name_offset = XCVR_QSFP_VENDOR_NAME_OFFSET
            xcvr_vendor_pn_offset = XCVR_QSFP_VENDOR_PN_OFFSET
            xcvr_hw_rev_offset = XCVR_QSFP_HW_REV_OFFSET
            xcvr_vendor_sn_offset = XCVR_QSFP_VENDOR_SN_OFFSET
            xcvr_vendor_oui_offset = XCVR_QSFP_VENDOR_OUI_OFFSET
            xcvr_vendor_date_offset = XCVR_QSFP_VENDOR_DATE_OFFSET
            ...
            offset = XCVR_QSFPDD_INFO_OFFSET
            xcvr_vendor_name_offset = XCVR_QSFPDD_VENDOR_NAME_OFFSET
            xcvr_vendor_pn_offset = XCVR_QSFPDD_VENDOR_PN_OFFSET
            xcvr_hw_rev_offset = XCVR_QSFPDD_HW_REV_OFFSET
            xcvr_vendor_sn_offset = XCVR_QSFPDD_VENDOR_SN_OFFSET
            xcvr_vendor_oui_offset = XCVR_QSFPDD_VENDOR_OUI_OFFSET
            xcvr_vendor_date_offset = XCVR_QSFPDD_VENDOR_DATE_OFFSET
            vendor_rev_width = XCVR_HW_REV_WIDTH_QSFPDD
            self.sfp_type = 'QSFPDD'
            sfpi_obj = qsfp_dd_InterfaceId()
        else:
            offset = XCVR_SFP_INFO_OFFSET
            xcvr_vendor_name_offset = XCVR_SFP_VENDOR_NAME_OFFSET
            xcvr_vendor_pn_offset = XCVR_SFP_VENDOR_PN_OFFSET
            xcvr_hw_rev_offset = XCVR_SFP_HW_REV_OFFSET
            xcvr_vendor_sn_offset = XCVR_SFP_VENDOR_SN_OFFSET
            xcvr_vendor_oui_offset = XCVR_SFP_VENDOR_OUI_OFFSET
            xcvr_vendor_date_offset = XCVR_SFP_VENDOR_DATE_OFFSET
        ...
        if sfpi_obj is None:
            self.logger.log_error('Error: sfp_object open failed')
            return None
        ...
        if self.is_qsfpdd():
            sfp_interface_type_data = sfpi_obj.parse_sfp_type(
                xcvr_info_raw[XCVR_TYPE_OFFSET:XCVR_TYPE_OFFSET + XCVR_TYPE_WIDTH], 0)
            sfp_interface_type_abbrv_name_data = sfpi_obj.parse_sfp_type_abbrv_name(
                xcvr_info_raw[XCVR_TYPE_OFFSET:XCVR_TYPE_OFFSET + XCVR_TYPE_WIDTH], 0)
            sfp_interface_connector_data = sfpi_obj.parse_connector(
                xcvr_info_raw[XCVR_QSFPDD_INTERFACE_CONNECTOR_OFFSET:XCVR_QSFPDD_INTERFACE_CONNECTOR_OFFSET + XCVR_QSFPDD_INTERFACE_CONNECTOR_WIDTH], 0)
        else:
        ...
        if self.is_qsfpdd():
            transceiver_info_dict['type'] = sfp_interface_type_data['data']['type']['value']
            transceiver_info_dict['type_abbrv_name'] = sfp_interface_type_abbrv_name_data['data']['type_abbrv_name']['value']
            transceiver_info_dict['connector'] = sfp_interface_connector_data['data']['Connector']['value']
        else:
        ...
        if self.is_qsfp():
            ...
            # TODO
            # transceiver_info_dict['cable_type']
            # transceiver_info_dict['cable_length']
            transceiver_info_dict['specification_compliance'] = '{}'
            # transceiver_info_dict['nominal_bit_rate']
            wavelength_raw = self.read_eeprom(
                XCVR_WAVELENGTH_QSFPDD_OFFSET,
                XCVR_WAVELENGTH_WIDTH,
                page=XCVR_WAVELENGTH_QSFPDD_PAGE)
            if wavelength_raw is None:
                transceiver_info_dict['wavelength'] = 'N/A'
            else:
    ...
    def get_transceiver_bulk_status(self):
        ...
        if self.is_qsfp():
            ...
            xcvr_dom_info_dict = self._get_qsfpdd_transceiver_bulk_status()
        else:
    ...
    def _get_qsfp_transceiver_bulk_status(self):
        ...
        sfpd_obj = sff8436Dom(calibration_type=self.get_calibration())
        if sfpd_obj is None:
            self.logger.log_error('Error: sfpd_object open failed')
            return None

        sfpi_obj = sff8436InterfaceId()
        if sfpi_obj is None:
            self.logger.log_error('Error: sfpi_object open failed')
            return None
    ...
    def _get_qsfpdd_transceiver_bulk_status(self):
        transceiver_dom_info_dict = {}
        ...
        # need to add more code for determining the capability and version compliance
        # in SFF-8636 dom capability definitions evolving with the versions.
        qsfp_dom_capability_raw = self.read_eeprom(XCVR_QSFPDD_INFO_OFFSET + XCVR_DOM_CAPABILITY_OFFSET,
                                                   XCVR_DOM_CAPABILITY_WIDTH)
        if qsfp_dom_capability_raw is not None:
            qspf_dom_capability_data = sfpi_obj.parse_dom_capability(qsfp_dom_capability_raw, 0)
        else:
            return None
        qsfp_temp_valt_raw = self.read_eeprom(QSFPDD_TEMP_VALT_OFFSET, QSFPDD_TEMP_VALT_WIDTH)
        if qsfp_temp_valt_raw is None:
            return None
        qsfp_dom_raw = self.read_eeprom(QSFPDD_DOM_OFFSET, QSFPDD_DOM_WIDTH, page=QSFPDD_DOM_PAGE)
        if qsfp_dom_raw is None:
            return None

        qsfp_temp_raw = qsfp_temp_valt_raw[0:2]
        qsfp_volt_raw = qsfp_temp_valt_raw[2:4]
        qsfp_channel_raw = qsfp_dom_raw

        parsed_temperature = sfpd_obj.parse_temperature(qsfp_temp_raw, 0)
        parsed_voltage = sfpd_obj.parse_voltage(qsfp_volt_raw, 0)
        dom_channel_monitor_data = sfpd_obj.parse_channel_monitor_params(qsfp_channel_raw, 0)

        transceiver_dom_info_dict['temperature'] = parsed_temperature['data']['Temperature']['value']
        transceiver_dom_info_dict['voltage'] = parsed_voltage['data']['Vcc']['value']
    ...
    def _get_sfp_transceiver_bulk_status(self):
        ...
        dom_channel_raw = dom_raw[SFP_CHANNEL_MON_OFFSET -
                                  SFP_DOM_OFFSET:SFP_CHANNEL_MON_OFFSET -
                                  SFP_DOM_OFFSET +
                                  SFP_CHANNEL_MON_WIDTH]
    ...
    def get_transceiver_threshold_info(self):
        ...
        if self.is_qsfp():
            ...
            transceiver_threshold_info_dict.update(self._get_qsfpdd_transceiver_threshold_info())
        else:
    ...
    def _get_qsfp_transceiver_threshold_info(self):
        ...
        dom_module_threshold_raw = self.read_eeprom(QSFP_MODULE_THRESHOLD_OFFSET,
                                                    ...
                                                    page=QSFP_MODULE_THRESHOLD_PAGE)
        ...
        dom_channel_threshold_raw = self.read_eeprom(QSFP_CHANNEL_THRESHOLD_OFFSET,
                                                     ...
                                                     page=QSFP_CHANNEL_THRESHOLD_PAGE)
    ...
    def _get_qsfpdd_transceiver_threshold_info(self):
        transceiver_threshold_info_dict = {}
        ...
        dom_module_threshold_raw = self.read_eeprom(QSFPDD_MODULE_THRESHOLD_OFFSET,
                                                    QSFPDD_MODULE_THRESHOLD_WIDTH,
                                                    page=QSFPDD_MODULE_THRESHOLD_PAGE)
        if dom_module_threshold_raw is None:
            return {}
        ...
        transceiver_threshold_info_dict['txbiashighalarm'] = dom_module_threshold_data['data']['TxBiasHighAlarm']['value']
        transceiver_threshold_info_dict['txbiashighwarning'] = dom_module_threshold_data['data']['TxBiasHighWarning']['value']
        transceiver_threshold_info_dict['txbiaslowalarm'] = dom_module_threshold_data['data']['TxBiasLowAlarm']['value']
        transceiver_threshold_info_dict['txbiaslowwarning'] = dom_module_threshold_data['data']['TxBiasLowWarning']['value']
    ...
    def get_rx_los(self):
        ...
        Otherwise call super.xxx() which is implemnted by sfpcommonbase.
    ...
    def get_lpmode(self):
        ...
        if self.is_qsfp():
            ...
            power_raw = self.read_eeprom(QSFPDD_POWER_MODE_OFFSET, QSFPDD_POWER_MODE_WIDTH)
            if power_raw is None:
                return None
            power_data = int(power_raw[0], 16)
            ...
            """
            CMIS4.0 Page 81
            # 3-1 Module state Current state of Module (see Table 8-3)
            Code Module state
            000b Reserved
            ...
            111b Reserved
            """
            module_state = (power_data >> 1) & 0x7
            lpmode = (module_state == 1)
        else:
            self.logger.log_error('SFP not support low power mode setting.')
            return None
    ...
    def get_power_override(self):
        ...
        if self.is_qsfpdd():
            ...
            self.logger.log_error('SFP not support power override setting.')
            return None
    ...
    def reset(self):
        ...
        """
        result = False
        self.logger.log_info('{} resetting...'.format(self.get_name()))
        result = self.set_reset(True)
        if result:
            time.sleep(0.5)
            result = self.set_reset(False)
    ...
    def tx_disable(self, tx_disable):
        ...
        tx_disable_list = []
        self.logger.log_info('{} set tx_disable {}...'.format(self.get_name(), tx_disable))
        if self.is_qsfp():
        ...
        if self.is_qsfpdd():
            ...
            if tx_disable:
                ...
                value = 0
            rev = self.write_eeprom(QSFPDD_CHANNEL_TX_DISABLE_OFFSET, [value], page=QSFPDD_CHANNEL_TX_DISABLE_PAGE)
            time.sleep(0.1)
            return rev
        else:
    ...
    def tx_disable_channel(self, channel, disable):
        ...
        self.logger.log_info('{} set channel{} tx_disable {}...'.format(self.get_name(), channel, disable))
        if self.is_qsfp():
            tx_disable_raw = self.read_eeprom(QSFP_CHANNEL_TX_DISABLE_OFFSET,
                                              QSFP_CHANNEL_TX_DISABLE_WIDTH)
            if tx_disable_raw is None:
            ...
            self.logger.log_debug('{} tx_disable_channel set {}'.format(self.get_name(), value))
            ...
            self.logger.log_error('SFP not support tx_diable_channel.')
    ...
    def set_lpmode(self, lpmode):
        ...
        self.logger.log_info('{} set low power mode {}...'.format(self.get_name(), lpmode))
        if self.is_qsfp():
            ...
            power_raw = self.read_eeprom(QSFPDD_SET_LPMODE_OFFSET, QSFPDD_SET_LPMODE_WIDTH)
            if power_raw is None:
                return None
            power_data = int(power_raw[0], 16)
            if lpmode:
                ...
                power_data &= ~(0x10)
            rev = self.write_eeprom(QSFPDD_SET_LPMODE_OFFSET, [power_data])
        else:
            self.logger.log_error('SFP not support low power mode setting.')
            return False
    ...
    def set_power_override(self, power_override, power_set):
        ...
        self.logger.log_info('{} set power override:{}, power set:{}...'.format(
            self.get_name(), power_override, power_set))
        if self.is_qsfp():
            power_raw = self.read_eeprom(QSFP_POWER_MODE_OFFSET, QSFP_POWER_MODE_WIDTH)
            if power_raw is None:
                return None
