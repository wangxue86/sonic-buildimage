...
def main():
    ...
    arg_err = False
    if product_name not in ['TCS81', 'TCS83', 'TCS82']:
        print "product name %s is invalid, TCS81/TCS83/TCS82" %product_name
        arg_err = True
    if Vendor not in ['H3C', 'Tencent']:
        print "Vendor %s is invalid, H3C/Tencent" %Vendor
        arg_err = True
